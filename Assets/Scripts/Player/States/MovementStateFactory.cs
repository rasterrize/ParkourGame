...
namespace Player.States
{
    public class MovementStateFactory
    {
        ...
        public MovementState NewWallRunState(RaycastHit wallHit, WallRunSide wallRunSide) { return new WallRunState(movement, this, wallHit, wallRunSide); }
        ...
        public MovementState NewInputBasedGroundState()
        {
            ...
            var isHoldingSprintKey = movement.IsHoldingSprintKey;
